...
Deno.serve((_request: Request) => {
  return new Response("hello! you've reached the snooze telegram bot. please leave a message after the beep...");
});
...
// on code, dm them an access code
bot.command("code", async (ctx: Context) => {
  await commands.issueAccessCode(bot, ctx);
});
