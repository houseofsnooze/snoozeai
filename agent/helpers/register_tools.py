...
def register_tools():
    ...
    agents.user_proxy.register_for_execution(name="run_tests")(run_tests)
    agents.user_proxy.register_for_execution(name="init_tests")(init_tests)
    ...
    agents.user_rep.register_for_execution(name="run_tests")(run_tests)
    agents.user_rep.register_for_execution(name="init_tests")(init_tests)
    ...
    agents.test_reviewer.register_for_llm(name="run_tests", description="Run the test")(run_tests)
    agents.test_reviewer.register_for_llm(name="init_tests", description="Initialize the tests")(init_tests)
    ...
    agents.test_reviewer.register_for_execution(name="run_tests")(run_tests)
    agents.test_reviewer.register_for_execution(name="init_tests")(init_tests)
    ...
    agents.test_fixer.register_for_llm(name="run_tests", description="Run the test")(run_tests)
    agents.test_fixer.register_for_llm(name="init_tests", description="Initialize the tests")(init_tests)
